      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex gap-3">
            <button className="px-4 py-2 bg-[#1A1F3D] border border-[#2A2F4D] rounded-lg text-gray-300 hover:text-white transition-colors text-sm flex items-center gap-2">
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center">
              <div className="text-5xl font-bold text-white mb-1" style={{ fontFamily: "monospace" }}>
                {score.score}
              </div>
            ...
            <div className="p-6 rounded-2xl bg-[#1A1F3D]/50 border border-[#2A2F4D]">
              <div className="space-y-2">
                {history.slice(0, 10).map((h, i) => (
                  <div key={i} className="flex items-center justify-between py-2 border-b border-[#2A2F4D] last:border-0">
                    <span className="text-sm text-gray-400">
                      {new Date(h.timestamp).toLocaleDateString()}
                    </span>
                    <span className="text-sm font-mono text-white">{h.score}</span>
                    <span className="text-xs" style={{ color: RISK_TIER_COLORS[h.riskTier] }}>
                      {h.riskTier}
                    </span>
                  </div>
                ))}
        ...
        {/* Disclaimer */}
        <div className="p-4 rounded-xl bg-[#1A1F3D]/30 border border-[#2A2F4D] text-xs text-gray-500">
          <p>
