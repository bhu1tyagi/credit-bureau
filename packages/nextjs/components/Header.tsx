...
const NetworkBadge = () => {
  ...
  return (
    <span
      className={`hidden sm:inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full text-[10px] font-semibold uppercase tracking-wider ${
        isMainnetMode ? "bg-emerald-500/15 text-emerald-400" : "bg-amber-500/15 text-amber-400"
      }`}
    >
      <span className={`w-1.5 h-1.5 rounded-full ${isMainnetMode ? "bg-emerald-400" : "bg-amber-400"}`} />
